...
# Константы
DELIVERY_COST = 220000  # Исправлено по вашему требованию
CUSTOMS_CLEARANCE = 80000
SITE_URL = "https://autozakaz-dv.ru/"
TELEGRAM_URL = "https://t.me/auto_zakaz_dv"  # Исправлено по вашему требованию
...
async def calculate_and_send_result(message: types.Message, state: FSMContext, data: dict, is_individual: bool, is_personal_use: bool):
    try:
        ...
        # Исправленный блок формирования результата
        result = (
